export const translations = {
  en: {
    ...
    providerCta: { title: 'Are You a Guide or Driver in Georgia?', sub: 'Join hundreds of providers already earning on GeorgiaTours. Set your own schedule, set your own prices.', apply: 'Apply to Join →', learn: 'Learn More' },
    finalCta: { title: 'Ready to Explore Georgia?', sub: 'Your adventure is one click away.', browse: 'Browse All Tours', create: 'Create Account' },
    ...
    login: { title: 'Sign in', subtitle: 'Use the same account as in the GeorgiaTours app.', backToHome: 'Back to home', iAm: 'I am', roleTourist: 'Tourist', roleGuide: 'Guide', roleDriver: 'Driver', roleAdmin: 'Admin', email: 'Email', password: 'Password', signIn: 'Sign in', signingIn: 'Signing in…' },
  ...
  ka: {
    ...
    login: { title: 'შესვლა', subtitle: 'იგივე ანგარიში, რაც GeorgiaTours აპში.', backToHome: 'მთავარი გვერდზე', iAm: 'მე ვარ', roleTourist: 'ტურისტი', roleGuide: 'ჰიდი', roleDriver: 'მძღოლი', roleAdmin: 'ადმინი', email: 'იმეილი', password: 'პაროლი', signIn: 'შესვლა', signingIn: 'შედის…' },
  ...
  ru: {
    ...
    login: { title: 'Вход', subtitle: 'Тот же аккаунт, что в приложении GeorgiaTours.', backToHome: 'На главную', iAm: 'Я', roleTourist: 'Турист', roleGuide: 'Гид', roleDriver: 'Водитель', roleAdmin: 'Админ', email: 'Email', password: 'Пароль', signIn: 'Войти', signingIn: 'Вход…' },
  ...
  ar: {
    ...
    login: { title: 'تسجيل الدخول', subtitle: 'نفس الحساب في تطبيق GeorgiaTours.', backToHome: 'العودة للرئيسية', iAm: 'أنا', roleTourist: 'سائح', roleGuide: 'مرشد', roleDriver: 'سائق', roleAdmin: 'مشرف', email: 'البريد', password: 'كلمة المرور', signIn: 'دخول', signingIn: 'جاري الدخول…' },
